...
let EntityModel = class EntityModel extends sequelize.Model {
};
__decorate([
...
], EntityModel.prototype, "entity_id", void 0);
__decorate([
    sequelize.AllowNull(false),
    sequelize.Unique,
    sequelize.Column(sequelize.DataType.STRING)
], EntityModel.prototype, "name_A", void 0);
__decorate([
    sequelize.AllowNull,
    sequelize.Column(sequelize.DataType.BOOLEAN)
], EntityModel.prototype, "y", void 0);
__decorate([
    sequelize.AllowNull(false),
    sequelize.Column(sequelize.DataType.INTEGER)
], EntityModel.prototype, "S", void 0);
__decorate([
    sequelize.AllowNull(false),
    sequelize.Column(sequelize.DataType.INTEGER)
], EntityModel.prototype, "N", void 0);
__decorate([
...
], EntityModel.prototype, "damages", void 0);
__decorate([
    sequelize.AllowNull,
    sequelize.CreatedAt,
    sequelize.Column(sequelize.DataType.DATE)
], EntityModel.prototype, "createdAt", void 0);
__decorate([
    sequelize.AllowNull,
    sequelize.UpdatedAt,
    sequelize.Column(sequelize.DataType.DATE)
], EntityModel.prototype, "updatedAt", void 0);
